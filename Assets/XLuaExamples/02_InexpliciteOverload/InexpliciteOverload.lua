...
print("Random.Range(0,10)\n", CS.UnityEngine.Random.Range(0, 10)) -- float和int在lua上无法区分，这里会调用Range(float, float)
print("OverloadWrap.RandomInt(0,10)\n", CS.EZhex1991.EZUnity.XLuaExample.OverloadWrap.RandomInt(0, 10)) -- 自己把这个方法封装一下RandomInt(int, int) -> Range(int, int)
print("OverloadWrap.RandomFoat(0,10)\n", CS.EZhex1991.EZUnity.XLuaExample.OverloadWrap.RandomFloat(0, 10)) -- RandomFloat(float, float) -> Range(float, float)
...
local hit2, info2 = CS.EZhex1991.EZUnity.XLuaExample.OverloadWrap.RaycastOut(ray) -- 自己封装Raycast(Ray, out HitInfo)
