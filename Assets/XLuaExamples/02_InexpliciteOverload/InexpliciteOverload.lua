...
print("OverloadWrap.RandomInt(0,10)", "->", CS.EZUnity.XLuaExample.OverloadWrap.RandomInt(0, 10)) -- 自己把这个方法封装一下RandomInt(int, int) -> Range(int, int)
print("OverloadWrap.RandomFoat(0,10)", "->", CS.EZUnity.XLuaExample.OverloadWrap.RandomFloat(0, 10)) -- RandomFloat(float, float) -> Range(float, float)
...
local hit2, info2 = CS.EZUnity.XLuaExample.OverloadWrap.Raycast(ray) -- 自己封装Raycast(Ray, out HitInfo)
