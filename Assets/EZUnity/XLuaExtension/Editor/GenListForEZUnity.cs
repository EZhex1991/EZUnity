...
namespace EZUnity.XLuaExtension
{
    public static class GenListForEZUnity
    {
        ...
        public static List<Type> LuaCallCSharp = new List<Type>()
        {
            ...
            typeof(EZUnity.XLuaExtension.LuaBehaviour),
            typeof(EZUnity.XLuaExtension.LuaInjector),
            ...
            typeof(EZUnity.EZDictionary.Element),
        ...
        public static List<Type> CSharpCallLua = new List<Type>()
        {
            ...
            typeof(EZUnity.XLuaExtension.LuaBehaviour.LuaAwake),
