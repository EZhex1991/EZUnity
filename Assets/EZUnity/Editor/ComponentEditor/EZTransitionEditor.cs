/*
 * Author:      熊哲
 * CreateTime:  12/28/2017 10:55:35 AM
 * Description:
 * 
*/
using UnityEditor;
...
namespace EZUnity
{
    [CustomEditor(typeof(EZTransition2)), CanEditMultipleObjects]
    public class EZTransitionEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                case (int)EZTransition2.TransitionType.None:
                    break;
                case (int)EZTransition2.TransitionType.Scale:
                    ...
                    break;
                case (int)EZTransition2.TransitionType.Size:
                    EditorGUILayout.PropertyField(m_RectTransform);
                    ...
                    break;
                case (int)EZTransition2.TransitionType.OutlineDistance:
                    ...
                    break;
                case (int)EZTransition2.TransitionType.OutlineColor:
                    EditorGUILayout.PropertyField(m_Outline);
