 ...
 * CreateTime:      2019-09-09 10:41:35
...
{
    public class EZTextureSingleLineDrawer : MaterialPropertyDrawer
    {
        ...
        public EZTextureSingleLineDrawer()
        {
        }
        public EZTextureSingleLineDrawer(string prop1)
        {
            extraPropertyName1 = prop1;
        }
        public EZTextureSingleLineDrawer(string prop1, string prop2)
        {
            extraPropertyName1 = prop1;
